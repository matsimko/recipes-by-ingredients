...
public interface IRecipeService
{
	...
	Task<Instruction> AddInstructionToRecipe(Instruction instruction, long recipeId, long userId);
	...
	Task RemoveInstructionFromRecipe(long instructionId, long recipeId, long userId);
